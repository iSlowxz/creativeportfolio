          ...
          <header className="col-span-12 grid grid-cols-12 border-t hairline pt-7">
            ...
            <div className="col-span-12 mt-5 md:col-span-10 md:mt-0">
              <Link
                href="/#works"
                data-cursor="link"
                className="mb-4 inline-flex w-fit border hairline px-3 py-1.5 font-mono text-[10px] uppercase tracking-[0.18em] text-[var(--ash)] transition-colors hover:text-[var(--foreground)]"
              >
                ← Back to Works
              </Link>
